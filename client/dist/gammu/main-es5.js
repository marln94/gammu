...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.api.login(this.correo, this.contrasena)
            ...
            if (r['status'] == 1) {
                _this.router.navigateByUrl('/admin/archivos');
            }
        }, function (r) { return console.error(r.error.error); });
    };
...
var SidenavComponent = /** @class */ (function () {
    function SidenavComponent(api, router) {
        this.api = api;
        this.router = router;
    ...
    SidenavComponent.prototype.ngAfterViewInit = function () {
        ...
        var instanceDropdown = materialize_css_dist_js_materialize__WEBPACK_IMPORTED_MODULE_3__["Dropdown"].init(this.dropdown1.nativeElement, {});
    };
